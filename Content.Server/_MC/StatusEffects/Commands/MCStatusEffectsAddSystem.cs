...
public sealed class MCStatusEffectsAddSystem : LocalizedCommands
{
    private const string Name = "mc_status_effects_add";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        system.TryAddTime(entityUid, protoId, TimeSpan.FromSeconds(duration));
    }
}
