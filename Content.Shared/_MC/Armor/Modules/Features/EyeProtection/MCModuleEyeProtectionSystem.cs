...
using Content.Shared._MC.Armor.Modules.Features.EyeProtection.Components;
using Content.Shared._MC.Armor.Modules.Features.EyeProtection.Events;
using Content.Shared.Actions;
using Content.Shared.Eye.Blinding.Components;

namespace Content.Shared._MC.Armor.Modules.Features.EyeProtection;
