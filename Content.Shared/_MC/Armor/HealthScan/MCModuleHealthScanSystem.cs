...
public sealed class MCModuleHealthScanSystem : EntitySystem
{
    ...
    private void OnActionMedicalScan(Entity<MCModuleHealthScanComponent> entity, ref MCArmorModuleRelayedEvent<MCModuleHealthScanActionEvent> relayedArgs)
    {
        ...
        if (_mcArmorModule.GetUser(entity) is not { } userUid || !TryComp<HealthScannerComponent>(entity, out var healthScanner))
            return;
