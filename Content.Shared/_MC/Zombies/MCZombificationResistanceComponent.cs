...
public sealed partial class MCZombificationResistanceComponent : Component
{
    /// <summary>
...
/// <summary>
/// Gets the total resistance from the MCZombificationResistanceComponent, i.e. just all of them multiplied together.
/// </summary>
public sealed class MCZombificationResistanceQueryEvent : EntityEventArgs, IInventoryRelayEvent
{
    /// <summary>
    ...
    public MCZombificationResistanceQueryEvent(SlotFlags slots)
    {
        TargetSlots = slots;
    }
}
